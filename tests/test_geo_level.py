...
from geo_level import (
    classify_amap_location,
    classify_first_amap_result,
...
class GeographicLevelTests(unittest.TestCase):
    ...
    def test_province_is_broader_than_city_and_district(self):
        self.assertEqual(compare_geographic_scope("province", "city"), "broader")
        self.assertEqual(compare_geographic_scope("province", "district"), "broader")
    ...
    def test_municipality_is_normalized_to_city_for_business_scope(self):
        ...
        self.assertEqual(result["source"], "amap_level_municipality_normalized")
    ...
    def test_poi_fields_are_finer_than_district(self):
        result = classify_first_amap_result(
            {
                "pois": [
                    {
                        "id": "B001",
        ...
        self.assertEqual(result["source"], "poi_fields")
        self.assertEqual(result["relative_to_district"], "finer")
